    ...
    return (
        <nav className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
            ...
            <div className="flex items-center gap-2 sm:gap-6">
                <Link href="/" className="flex items-center gap-2 px-3 py-2 text-gray-600 transition-colors hover:text-indigo-600 group">
                ...
                <Link href="/timeline" className="flex items-center gap-2 px-3 py-2 text-gray-600 transition-colors hover:text-indigo-600 group">
                ...
                <Link href="/stats" className="flex items-center gap-2 px-3 py-2 text-gray-600 transition-colors hover:text-indigo-600 group">
